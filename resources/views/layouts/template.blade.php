  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="index3.html" class="brand-link">
        ...
        <span class="brand-text font-weight-light">HealthInspection</span>
      </a>
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          <div class="image">
            <img
              src="{{! Auth::user()->imagePath ? Storage::url('images/default.jpg' ):Storage::url('images/' .  Auth::user()->imagePath) }}"
              class="img-circle elevation-2" alt="aff" style="object-fit: cover; width: 40px; height:40px;">
          </div>

          <div class="info">
            <a href="{{ route('users.edit', ['user' => Auth::user()->id]) }}" class="d-block">{{
